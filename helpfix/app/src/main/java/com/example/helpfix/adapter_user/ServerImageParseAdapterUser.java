...
public class ServerImageParseAdapterUser {
    public static ServerImageParseAdapterUser SIAdapter;
    ...
    private ServerImageParseAdapterUser(Context context) {
    ...
    public static ServerImageParseAdapterUser getInstance(Context SynchronizedContext) {
        if (SIAdapter == null) {
            SIAdapter = new ServerImageParseAdapterUser(SynchronizedContext);      }
        return SIAdapter;
    }
