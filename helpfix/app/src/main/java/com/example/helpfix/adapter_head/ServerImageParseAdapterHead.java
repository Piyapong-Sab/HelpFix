...
public class ServerImageParseAdapterHead  {
    public static ServerImageParseAdapterHead SIAdapter;
        ...
        private ServerImageParseAdapterHead(Context context) {
        ...
        public static ServerImageParseAdapterHead getInstance(Context SynchronizedContext) {
            if (SIAdapter == null) {
                SIAdapter = new ServerImageParseAdapterHead(SynchronizedContext);      }
            return SIAdapter;
        }
