...
import com.example.helpfix.adapter_head.RecyclerViewAdapterHeadAssignment;
...
public class Assignment_list extends AppCompatActivity implements RecyclerViewAdapterHeadAssignment.OnItemClickListener {


    private List<GetDataAdapterHead> mDataList;
    private RecyclerView recyclerView;
    private RecyclerViewAdapterHeadAssignment recyclerViewadapter;
    String GET_JSON_DATA_HTTP_URL = "http://203.158.131.67/~devhelpfix/apphelpfix/view_assignment.php";
    ...
    public void JSON_PARSE_DATA_AFTER_WEBCALL(JSONArray array){
        ...
        recyclerViewadapter = new RecyclerViewAdapterHeadAssignment(mDataList, this);
        recyclerView.setAdapter(recyclerViewadapter);
        recyclerViewadapter.setOnItemClickListener(Assignment_list.this);
    }
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.Home:
                        Intent intent = new Intent(Assignment_list.this, Mainhead_division.class);
                        startActivity(intent);
                        break;

                    case R.id.Application:
                        Intent intent1 = new Intent(Assignment_list.this, Assignment_list.class);
                        startActivity(intent1);
                        break;

                    case R.id.RepairWork:
                        Intent intent2 = new Intent(Assignment_list.this, Repair_notification_list.class);
                        startActivity(intent2);
                        break;
                    case R.id.SubmittedApplication:
                        Intent intent3 = new Intent(Assignment_list.this, Work_list.class);
                        startActivity(intent3);
                        break;
                    case R.id.ApprovalRequest:
                        Intent intent4 = new Intent(Assignment_list.this, Sentapproval_list.class);
