...
public class RecyclerViewAdapterTechnicianRepairable extends RecyclerView.Adapter<RecyclerViewAdapterTechnicianRepairable.ViewHolder > {
    ...
    public RecyclerViewAdapterTechnicianRepairable(List<GetDataAdapterTechnician> getDataAdapter, Response.Listener<String> context){
        super();
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.recyclerview_repairable_tech, parent, false);
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        public TextView view_issueid ,view_evaluatedt,view_priority,view_problem,view_status;
