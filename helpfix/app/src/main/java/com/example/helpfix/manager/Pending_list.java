...
public class Pending_list extends AppCompatActivity implements RecyclerViewAdapterManager.OnItemClickListener {

    private List<GetDataAdapterManager> mDataList;
    private RecyclerView recyclerView;
    private RecyclerViewAdapterManager recyclerViewadapter;

    String GET_JSON_DATA_HTTP_URL = "http://203.158.131.67/~devhelpfix/apphelpfix/view_pendingmanager.php";
    ...
    public void JSON_PARSE_DATA_AFTER_WEBCALL(JSONArray array){
        ...
        recyclerViewadapter = new RecyclerViewAdapterManager(mDataList,Pending_list.this);
        recyclerView.setAdapter(recyclerViewadapter);
        recyclerViewadapter.setOnItemClickListener(Pending_list.this);
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.Home:
                        Intent intent = new Intent(Pending_list.this, Mainmanager.class);
                        startActivity(intent);
                        break;

                    case R.id.ApprovalRequest:
                        Intent intent1 = new Intent(Pending_list.this, Pending_list.class);
                    ...
                    case R.id.ApprovedApplication:
                        Intent intent3 = new Intent(Pending_list.this, Approve_list.class);
    ...
    public void onItemClick(int position) {
        ...
        Intent intent = new Intent(getApplicationContext() ,Managepending.class);
