...
public class RecyclerViewAdapterUser extends RecyclerView.Adapter<RecyclerViewAdapterUser.ViewHolder > {
    ...
    List<GetDataAdapterUser> mDataList;
    ...
    public RecyclerViewAdapterUser(List<GetDataAdapterUser> getDataAdapter, Response.Listener<String> context){
        super();
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.recyclerview_issueuser, parent, false);
        ViewHolder viewHolder = new ViewHolder(v);
        return viewHolder;
    }
    @Override
    public void onBindViewHolder(ViewHolder Viewholder, int position) {
        GetDataAdapterUser getDataAdapter1 =  mDataList.get(position);

        Viewholder.view_idissue.setText(getDataAdapter1.getIdissue());
