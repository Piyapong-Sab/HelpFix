...
public class RecyclerViewAdapterHeadRepair extends RecyclerView.Adapter<RecyclerViewAdapterHeadRepair.ViewHolder > {
    Context context;
    ...
    public RecyclerViewAdapterHeadRepair(List<GetDataAdapterHead> getDataAdapter, Context context){
        super();
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.recyclerview_repair_noti_head, parent, false);
