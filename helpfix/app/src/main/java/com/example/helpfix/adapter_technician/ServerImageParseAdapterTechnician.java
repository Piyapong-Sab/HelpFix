...
public class ServerImageParseAdapterTechnician{
        public static ServerImageParseAdapterTechnician SIAdapter;
        ...
        private ServerImageParseAdapterTechnician(Context context) {
        ...
        public static ServerImageParseAdapterTechnician getInstance(Context SynchronizedContext) {
            if (SIAdapter == null) {
                SIAdapter = new ServerImageParseAdapterTechnician(SynchronizedContext);      }
            return SIAdapter;
        }
