...
import com.example.helpfix.adapter_technician.RecyclerViewAdapterTechnicianPending;
...
public class Pending_list_tech extends AppCompatActivity implements RecyclerViewAdapterTechnicianPending.OnItemClickListener {

    private List<GetDataAdapterTechnician> mDataList;
    private RecyclerView recyclerView;
    private RecyclerViewAdapterTechnicianPending recyclerViewadapter;
    String GET_JSON_DATA_HTTP_URL = "http://203.158.131.67/~devhelpfix/apphelpfix/view_pending_techlist.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pending_list_tech);
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.Home:
                        Intent intent0 = new Intent(Pending_list_tech.this, Maintechnician.class);
                        startActivity(intent0);
                        break;

                    case R.id.RepairApplication:
                        Intent intent1 = new Intent(Pending_list_tech.this, Assessment_list.class);
                        startActivity(intent1);
                        break;

                    case R.id.CompletedRepair:
                        Intent intent2 = new Intent(Pending_list_tech.this, Repair_notification_technician.class);
                        startActivity(intent2);
                        break;
                    case R.id.ApprovalWait:
                        Intent intent3 = new Intent(Pending_list_tech.this, Pending_list_tech.class);
                        startActivity(intent3);
                        break;
                    case R.id.ApplicationsClosed:
                        Intent intent4 = new Intent(Pending_list_tech.this, Repairable_list_tech.class);
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if(obj.optString("status").equals("true")){
                                ...
                                recyclerViewadapter = new RecyclerViewAdapterTechnicianPending(mDataList, this);
                                recyclerView.setAdapter(recyclerViewadapter);
                                recyclerViewadapter.setOnItemClickListener(Pending_list_tech.this);
